# Generated by Django 3.2 on 2025-03-04 08:16
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('email', models.EmailField(help_text='Укажите адрес Вашей электронной почты.', max_length=254, unique=True, verbose_name='Адрес почты')),
                ('username', models.CharField(help_text='Укажите Ваш никнейм', max_length=150, unique=True, validators=[users.validators.validate_username], verbose_name='Имя пользователя (никнейм)')),
                ...
                ('password', models.CharField(help_text='Укажите Ваш пароль', max_length=128, validators=[users.validators.validate_password], verbose_name='Пароль')),
